...
def render_branding():
    st.markdown(
        ...
        <style>
            .hero {
                ...
                /* works better in both light and dark mode */
        ...
        <div class="hero">
            <div class="hero-title">
                Legal Document & Boundary Records Portal
            </div>
    ...
    with st.expander("About this prototype", expanded=False):
        st.markdown(
            """
            This prototype connects OCR text, document metadata,
            PDF retrieval, and GIS boundary records into one searchable system.
